    ...
    render() {
        ...
        return (
            <div className="DanceMarathon">
                <img src="/projects/dance-marathon.png" className="DanceMarathon-photo" alt="CUDM"/><br/>
                ...
                <img src="/projects/dance-marathon2.gif" className="DanceMarathon-photo" alt="CUDM"/><br/>
            </div>
        );
    }
}
