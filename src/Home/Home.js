...
class Home extends Component {
    ...
    render() {
        ...
        return (
            ...
            <h1 className="Home-main-text">
                Most recently, I learned <Link to="/spiced" className="Home-link link anim-middleout">how to code</Link>, which has made me a better researcher, storyteller, and <Link to="/gene" className="Home-link link anim-middleout">designer</Link>. I'm __. I’m particularly interested in the intersection of geography and technology, which I explore <a href="https://aleesteele.github.io/" className="Home-link link anim-middleout">here</a>.
            </h1>
            <h1 className="Home-main-text">
              Check out my <a href="http://www.aleesteele.com/Anne-Lee-Steele-CV.pdf" className="Home-link link anim-middleout" download="Anne-Lee-Steele-C18.pdf">CV</a>, <a href="http://linkedin.com/in/anneleesteele" className="Home-link link anim-middleout">LinkedIn</a>, or social media to learn more about me, or <a href="mailto:aleesteele@gmail.com" className="Home-link link anim-middleout">get in touch ✉</a>. Thanks! -Anne
                </h1> */}
                <h1 className="Home-main-text">
                    Hello, world.<br/>
