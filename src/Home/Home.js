...
import '../App/App.css';
import './Home.css';
import '../SocialIcons/SocialMedia.css';
...
class Home extends Component {
    ...
    render() {
        return (
            <div className="Home">
                <h1 className="Bio-main-text">
                  I'm Anne Lee Steele, an MA candidate at the Graduate Institute of International and Development Studies. I'm interested in how technology and the environment affect people (and their politics).
                </h1>
                <h1 className="Bio-main-text">
