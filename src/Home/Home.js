    ...
    render() {
        ...
        return (
            ...
            <div className="Home">
                ...
                <h1 className="Home-main-text">
                    Most recently, I learned <Link to="/spiced" className="Home-link link anim-middleout">how to code</Link>, which has made me a better researcher, storyteller, and <Link to="/gene" className="Home-link link anim-middleout">designer</Link>. I’m particularly interested in the intersection of geography and technology, which I blog about <a href="https://aleesteele.github.io/" className="Home-link link anim-middleout">here</a>.
                </h1>
                <h1 className="Home-main-text">
