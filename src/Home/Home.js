    ...
    render() {
        ...
        return (
            <div className="Home">
                ...
                <h1 className="Home-main-text">
                    Most recently, I learned <Link to="/spiced" className="Home-link link anim-middleout">how to code</Link>, which has made me a better researcher, storyteller, and <Link to="/gene" className="Home-link link anim-middleout">designer</Link>. Check out my <Link to="/about" className="Home-link link anim-middleout">resume</Link> or <a href="https://www.linkedin.com/in/anneleesteele" className="Home-link link anim-middleout">LinkedIn</a> to learn more about me, or <a href="mailto:aleesteele@gmail.com" className="Home-link link anim-middleout">get in touch ✉</a>. (cc: <a href="https://github.com/aleesteele/" className="Home-link link anim-middleout">Github</a>, <a href="https://twitter.com/anneleesteele/" className="Home-link link anim-middleout">Twitter</a>, <a href="https://instagram.com/anneleesteele/" className="Home-link link anim-middleout">Instagram</a>).
                </h1>
            </div>
        );
    }
