    ...
    render() {
        ...
        return (
            <div className="Home">
                ...
                <h1 className="Home-main-text">
                    Most recently, I learned <Link to="/spiced" className="Home-link link anim-middleout">how to code</Link> in Berlin, which has made me a better researcher, storyteller, and <Link to="/gene" className="Home-link link anim-middleout">designer</Link>. I'm fascinated by the intersection of technology and the social world (especially how it relates to sustainability, human rights, and our global economy).
                </h1>
                <h1 className="Home-main-text">
