    ...
    render() {
        ...
        return (
            <div className="Home">
                ...
                <h1 className="Home-main-text">
                    Most recently, I <Link to="/spiced" className="Home-link link anim-middleout">learned how to code</Link> in Berlin, which has made me a better researcher, storyteller, and <Link to="/gene" className="Home-link link anim-middleout">designer</Link>. Ultimately, I'm passionate about the social world, particularly when it comes to technology, development, and sustainability.
                </h1>
                <h1 className="Home-main-text">
